...
class OrganizationRepositoryAccessor: NSObject, RepositoryAccessorProtocol {
    ...
    private func dummyOrganizations() {
        ...
        organizations.append(Organization(entity: ("Easter Seals",0), tagline: "", mission: "", target: "", structure: OrganizationalStructure.MainOfficeWithChapters, scope: GeographicScope.National, location:LocationProfile(latitude: 0.0,longitude: 0.0,city: "",state: "",zip: ""), url: ""))
        
        organizations.append(Organization(entity: ("United Way",0), tagline: "", mission: "", target: "", structure: OrganizationalStructure.MainOfficeWithChapters, scope: GeographicScope.National, location:LocationProfile(latitude: 0.0,longitude: 0.0,city: "",state: "",zip: ""), url: ""))
    }
