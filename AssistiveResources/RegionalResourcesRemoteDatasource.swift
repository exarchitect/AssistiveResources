...
func testEvents() -> [StoredEvent] {
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Best Buddies Spring Gala", identifier: 110),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Challenger Baseball Field of Dreams", identifier: 111),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Penguin Project \"Crazy For You\"", identifier: 112),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Special Olympics", identifier: 113),
                                    organization: OrganizationDescriptor(name: "Athletes In Action", identifier: 4),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Easter Seals Open House", identifier: 114),
