...
func testEvents() -> [StoredEvent] {
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Best Buddies Spring Gala", identifier: 0),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Challenger Baseball Field of Dreams", identifier: 1),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Penguin Project \"Crazy For You\"", identifier: 1),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Special Olympics", identifier: 1),
                                    organization: OrganizationDescriptor(name: "Athletes In Action", identifier: 0),
    ...
    events.append(StoredEvent(event: EventDescriptor(name: "Easter Seals Open House", identifier: 1),
